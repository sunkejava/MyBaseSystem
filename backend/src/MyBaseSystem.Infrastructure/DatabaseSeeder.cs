...
public static class DatabaseSeeder
{
    public static async Task InitializeAsync(AppDbContext db, PasswordHasher<User> hasher, CancellationToken ct = default)
    {
        ...
        // EnsureCreated 不会升级已有数据库，新增模块使用幂等建表保证平滑启动。
        await db.Database.ExecuteSqlRawAsync("CREATE TABLE IF NOT EXISTS \"Notifications\" (\"Id\" TEXT NOT NULL PRIMARY KEY,\"UserId\" TEXT NULL,\"Title\" TEXT NOT NULL,\"Message\" TEXT NOT NULL,\"Type\" TEXT NOT NULL,\"IsRead\" INTEGER NOT NULL,\"ActionUrl\" TEXT NULL,\"CreatedAt\" INTEGER NOT NULL,\"CreatedBy\" TEXT NULL,\"UpdatedAt\" INTEGER NULL,\"UpdatedBy\" TEXT NULL,\"IsDeleted\" INTEGER NOT NULL)",ct);
